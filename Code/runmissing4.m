%%This script computes rmse values of ppca, knn student, and knn course in
%%terms of their pridiction of the removed senior year scores.
%移除大四
...
function ans = runmissing4g(dataset, merge, R)
    ...
    for i = 4:4%:size(dataset, 2)
        ...
        t.cour = (rcour);
        t.info = info{i};
        t.courRslt = (courPred); %courRslt is the imputed score matrix.
        t.answer = testy(comparepart)*ysigma + ymean; %answer is the ground truth of the comparing part.
        ans{i} = t;
   end
end