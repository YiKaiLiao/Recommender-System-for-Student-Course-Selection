...
%配合課程地圖 ex: mec={'專題實驗（二）','網路安全概論','影像處理概論','嵌入式系統軟體設計與實作'}
    ...
    switch dep
        case 1
            mec = {'專題實驗（二）', '網路安全概論', '計算機結構', '多媒體系統', '微處理機應用設計', '微處理機應用設計', '近代數位系統設計', '個人軟體程序程式', '資料庫系統', '電信網路概論', '超大型積體電路系統設計概論', 'Java程式設計', '嵌入式系統軟體設計與實作', '影像處理概論', '網路程式設計'};
            ans.name = '資工';
        case 2
            mec = {'機電專題實作', 'CNC製造聯網整合技術', '嵌入式控制器設計', '專利寫作理論與實務', '創意工程設計', '專利侵害鑑定理論與實務', '精密工具機技術', '應用光學與實務', '數值方法', '機械工程與綠色科技', '工具機概論'};
            ans.name = '機械';
        case 3
            mec = {'論文撰寫'};
            ans.name = '勞工';
        case 4
            mec = {'策略資訊管理', '顧客關係管理', '電子化供應鏈管理', '資訊管理個案研究', '資料探勘與應用'};
            ans.name = '資管';
    end
    cour4 = [];
    for i = 1:size(rs, 2)
